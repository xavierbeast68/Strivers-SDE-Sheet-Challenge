//* https://www.codingninjas.com/codestudio/problems/reverse-pairs_1112652
...
public:
    ...
    int numberOfReversePairs(vector<int>& arr, int n) {
...
int reversePairs(vector<int> &arr, int n){
    ...
    //* TC- O(2n*logn), SC- O(n);
    MergeAlgo obj;
    return obj.numberOfReversePairs(arr, n);
}